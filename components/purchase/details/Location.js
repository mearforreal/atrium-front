    ...
    <>
      <div className={styles.nearLocation}>
        <Heading
          caption={"О ПРОЕКТЕ"}
          h2={"РАСПОЛОЖЕНИЕ"}
          p={`Богатая инфраструктура, удобная связь с другими районами мегаполиса и прекрасная экологическая обстановка делают ${projectTitle} привлекательным выбором для жизни.`}
        />
