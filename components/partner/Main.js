...
const Main = () => {
  return (
    <div className={styles.partnerMain + " " + "wrapper"}>
      <Image className={styles.partnerMain_img1} src={img1} alt="img1" />
      ...
      <div className={styles.partnerMain_content}>
        <Image src={img2} className={styles.partnerMain_img2} alt="img2" />
      ...
      <Image src={img3} className={styles.partnerMain_img3} alt="img3" />
      <Image src={img4} className={styles.partnerMain_img4} alt="img4" />
    </div>
  );
};
